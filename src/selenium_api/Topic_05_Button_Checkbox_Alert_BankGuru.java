...
public class Topic_05_Button_Checkbox_Alert_BankGuru {
	WebDriver driver;
...
//			Step 03 - Kiểm tra radio button đó đã chọn hay chưa/ nếu chưa chọn lại
	...
	public void TC04() throws Exception {
		open_page("http://demo.guru99.com/v4/manager/DeleteCustomerInput.php");
		By AlertByButton = By.xpath("//input[@type='submit']");
		clickXpathByJavascript(AlertByButton);
		Alert alert1 = driver.switchTo().alert();
		alert1.accept();
		Thread.sleep(5000);
//		Assert.assertTrue(driver.findElement(By.xpath("//p[@class='heading3' and text()='Account Deleted Successfully!!!']")).isDisplayed());
	}
